...
const Combination_Results: Dictionary = {
	...
	# Carbonate recipies
	"33,1" : "Hydrogen reacts with carbonates to form carbonic acid (H₂CO₃), but carbonic acid is unstable and decomposes quickly into carbon dioxide (CO₂) and water (H₂O). It doesn't just create a stable compound with hydrogen alone.",
	"33,2" : "Helium is a noble gas, which means it doesn't react with carbonates or anything else. It’s happy staying inert and not forming compounds.",
	"33,3" : "Lithium reacts with carbonates to form lithium carbonate (Li₂CO₃), but this is already a carbonate itself! Lithium just keeps carbonates as they are without creating anything new or interesting here.",
	"33,4" : "Beryllium reacts with carbonates to form beryllium carbonate (BeCO₃). It doesn't bond in any unusual way with carbonates but rather forms a simple carbonate compound.",
	"33,5" : "Boron doesn’t react directly with carbonates. It prefers forming borates, so it doesn’t bond with carbonates in any noticeable way.",
	"33,6" : "Carbon can reduce carbonates when heated, causing the carbonate to break down into carbon dioxide (CO₂) and a metal oxide (like CaO from calcium carbonate), often used in industrial processes.",
	"33,7" : "Nitrogen doesn’t react with carbonates. Nitrogen tends to form nitrogen oxides (NO₂) or nitrates (NO₃⁻) but not carbonates.",
	"33,8" : "Carbonates already contain oxygen in their structure, so adding more oxygen doesn't create a new compound. Instead, it may lead to decomposition under heat, releasing carbon dioxide (CO₂) and oxygen (O₂).",
	"33,9" : "Fluorine is too reactive and typically bonds with metals or oxygen. It doesn’t mix with carbonates but will react with other elements to form fluorides.",
	"33,10" : "Neon is a noble gas, so it doesn't react with carbonates or any other compounds. It stays inert and doesn’t form any new bonds.",
	"33,11" : "Sodium reacts with carbonates to form sodium carbonate (Na₂CO₃). It just forms simple carbonates without creating anything new.",
	"33,12" : "Magnesium reacts with carbonates to form magnesium carbonate (MgCO₃). Like sodium, it just forms a simple carbonate.",
	"33,13" : "Aluminum reacts with carbonates to form aluminum carbonate (Al₂(CO₃)₃), but this reaction often requires certain conditions, and aluminum doesn't typically form carbonates easily.",
	"33,14" : "Silicon doesn’t react with carbonates under normal conditions. Silicon prefers forming silicon dioxide (SiO₂) rather than interacting with carbonates.",
	"33,15" : "Phosphorus doesn’t react with carbonates directly. It typically forms phosphates rather than carbonates.",
	"33,16" : "Sulfur doesn’t bond with carbonates. It forms sulfur oxides (SO₂) and sulfuric acid (H₂SO₄), not carbonates.",
	"33,17" : "Chlorine reacts with metals, but not carbonates in a straightforward way. It forms chlorides when it bonds with other elements, not carbonates.",
	"33,18" : "Argon is a noble gas. It doesn’t react with anything, including carbonates, so it doesn't form any compounds.",
	"33,19" : "Potassium reacts with carbonates to form potassium carbonate (K₂CO₃). Like sodium, it simply forms a basic carbonate, but nothing new or exciting happens.",
	"33,21" : "Scandium reacts with carbonates to form scandium carbonate (Sc₂(CO₃)₃), but it just forms carbonates without creating anything different or complex.",
	"33,22" : "Titanium doesn’t react with carbonates easily. It prefers forming titanium dioxide (TiO₂) rather than reacting with carbonates.",
	"33,23" : "Vanadium doesn’t bond with carbonates directly, preferring to form vanadium oxides rather than reacting with carbonates.",
	"33,24" : "Chromium reacts with carbonates to form chromium carbonate (Cr₂(CO₃)₃), but it just creates another simple carbonate, not a more complex reaction.",
	"33,25" : "Manganese reacts with carbonates to form manganese carbonate (MnCO₃), like most metals. It doesn’t make anything special when reacting with carbonates.",
	"33,26" : "Iron reacts with carbonates to form iron carbonate (FeCO₃). It doesn’t produce anything surprising and simply forms another basic carbonate.",
	"33,27" : "Cobalt reacts with carbonates to form cobalt carbonate (CoCO₃), but it just produces a simple carbonate, not anything unique.",
	"33,28" : "Nickel reacts with carbonates to form nickel carbonate (NiCO₃), continuing the trend of forming simple carbonates without any special reaction.",
	"33,29" : "Copper reacts with carbonates to form copper carbonate (CuCO₃). Like other metals, it just forms a basic carbonate without anything new.",
	"33,30" : "Zinc reacts with carbonates to form zinc carbonate (ZnCO₃), just like the other metals. It forms a basic carbonate.",
}
